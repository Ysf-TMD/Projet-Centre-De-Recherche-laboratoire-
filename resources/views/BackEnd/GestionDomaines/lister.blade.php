        ...
        <div class="container-fluid ">
            <div class="text-light text-center">
                ...
                <span class="text-light h3 ">
                    <strong>
                        Voici la liste De Domaines Ajouté
                    </strong>
                </span>
                ...
                <div class="d-flex">
                    ...
                    <div class="container-fluid text-end">
                        <a class="btn btn-success " href="{{route("domaines.create")}}">Ajouter Domaine</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                @foreach($domaines as $domaine)
                    <div class="col">
                        <div class="card shadow">
                            <img src="{{asset("storage/$domaine->image")}}" class="card-img-top " alt="pas d'image Insérer " class="img-fluid">
                            <div class="card-body bg-black bg-gradient  text-light">
                                ...
                                <hr>
                                <p class="card-text">
                                <p><strong>Genre : </strong><span class="text-primary"> {{$domaine->genre}}</span></p>
                                <p><strong>Description : </strong><span class="text-primary"> {{$domaine->description}}</span></p>
                                </p>
                            </div>
                            <div class="card-footer bg-black  bg-gradient ">
                                <div class="col-md-12 row row-cols-auto g-3 justify-content-center">

                                    <a class=" bg-warning text-black btn p-2 rounded badge" href="{{route("domaines.edit",$domaine)}}">
                                    ...
                                    <a class=" bg-info text-black btn p-2 rounded badge" href="{{route("ListeArticle",$domaine->id)}}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor" class="bi bi-pencil-square " viewBox="0 0 16 16">
                                            <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                                            <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                                        </svg>
                                    ...
                                    <form action="{{route("relationDomaine",$domaine)}}" method="POST">
                                        @csrf
                                        <button class=" bg-success text-black btn p-2 rounded badge"  type="submit">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor" class="bi bi-pencil-square " viewBox="0 0 16 16">
                                                <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                                                <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                                            </svg>
                                            Afficher chercheurs liés</button>
                                    </form>

                                    <form action="{{route("domaines.destroy",$domaine)}}" method="post">
                                        @csrf
                                        @method("DELETE")
                                        <button class="bg-danger text-black btn p-2 rounded badge" >
